...
public class JdbcProductRepositoryImpl implements ProductRepository{
    ...
    public List<Product> findAllProducts(){
        try(var connection = dataSource.getConnection(); var preparedStatement = connection.prepareStatement(SELECT_ALL_PRODUCTS)){
    ...
    public Optional<Product> findById(Long productId){
        try(var connection = dataSource.getConnection(); var prepareStatement = connection.prepareStatement(SELECT_PRODUCT_BY_ID)){
