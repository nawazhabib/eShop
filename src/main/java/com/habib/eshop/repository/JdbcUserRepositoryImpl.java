...
public class JdbcUserRepositoryImpl implements UserRepository{
    ...
    public void save(User user){
        try(var connetion = dataSource.getConnection(); var preparedStatement = connetion.prepareStatement(SAVE_USER)){
    ...
    public Optional<User> findByUsername(String usrename){
        try(var conneciton = dataSource.getConnection(); var preparedStatement = conneciton.prepareStatement(SELECT_BY_USERNAME)){
    ...
    private List<User> extractUser(ResultSet resultSet) throws SQLException{
        ...
        while (resultSet.next()){
            ...
            user.setDateLastUpdated(resultSet.getTimestamp("date_last_update").toLocalDateTime());
